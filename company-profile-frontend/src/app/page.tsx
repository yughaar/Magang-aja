...
import CardSlider from "./services/cardSlider";
  ...
  return (
    <div className="flex flex-col items-center text-center p-6 bg-white rounded-xl shadow-sm">
      <div className="mb-4 w-16 h-16 rounded-full border-2 border-[#F3732A] flex items-center justify-center">
        <div className="w-8 h-8 text-[#1D3380]">{icon}</div>
      </div>
...
const servicesData = [
  ...
  },
  {
    ...
    description:
      "Robust database design, optimization, and management solutions for efficient data handling and storage.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Seamless integration of various systems and platforms to streamline your business operations.",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              We deliver exceptional technology solutions backed by years of
            ...
            <FeatureCard
              icon={
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-6 h-6 text-[#F3732A]"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3 7.5a6.01 6.01 0 0 0-3-7.5m3 7.5a6.01 6.01 0 0 1-3-7.5m-6 0a6.01 6.01 0 0 0 3 7.5m-3-7.5a6.01 6.01 0 0 1 3-7.5m0 0a6.01 6.01 0 0 0-3 7.5m0 0a6.01 6.01 0 0 1-3 7.5"
                  />
                </svg>
              }
              ...
              icon={
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M12 9v3.75m0-10.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.333 9-6.03 9-11.623 0-1.604-.43-3.112-1.2-4.434M15 2.5a11.959 11.959 0 0 1-6 0M12 2.25v19.5"
                  />
                </svg>
              }
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              HANADIV TECH is a leading technology company dedicated to
              delivering innovative solutions that empower businesses to thrive
              in the digital age. With a relentless focus on quality and a
              passion for excellence, we transform complex challenges into
              ...
              icon={
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-3.741-5.584M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"
                  />
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M12 15v2.25A2.25 2.25 0 0 1 9.75 19.5h-4.5A2.25 2.25 0 0 1 3 17.25V15m1.5-6c0-3.032 2.682-5.5 6-5.5s6 2.468 6 5.5m-1.5 0v-2.251a2.25 2.25 0 0 0-2.25-2.25H15M9 15v2.25A2.25 2.25 0 0 0 11.25 19.5h4.5A2.25 2.25 0 0 0 18 17.25V15"
                  />
                </svg>
              }
              title="Our Values"
