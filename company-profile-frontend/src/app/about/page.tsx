...
function InfoCard({ icon, title, description }: InfoCardProps) {
  return (
    <div className="flex flex-col items-center text-center p-6 border border-gray-200/80 rounded-xl">
      {/* Ikon */}
...
export default function AboutUs() {
  return (
    ...
    <div className="bg-hanadiv-blue">
      ...
      {/* 3. Kartu Putih Besar "Who We Are" */}
      ...
      <section className="pb-16 pt-0 px-4">
        <div className="bg-white max-w-6xl mx-auto p-10 md:p-12 rounded-2xl shadow-xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              <h3 className="text-4xl font-bold text-hanadiv-orange mb-1">10+</h3>
              <p className="text-gray-600">Years Experience</p>
            </div>
            
            <div>
              <h3 className="text-4xl font-bold text-hanadiv-orange mb-1">500+</h3>
              <p className="text-gray-600">Projects Completed</p>
            </div>

            <div>
              <h3 className="text-4xl font-bold text-hanadiv-orange mb-1">200+</h3>
              <p className="text-gray-600">Happy Clients</p>
            </div>

            <div>
              <h3 className="text-4xl font-bold text-hanadiv-orange mb-1">50+</h3>
